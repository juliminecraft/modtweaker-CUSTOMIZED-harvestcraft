...
#Grinder:
mods.harvestcraft.Grinder.addAll(<ore:coal>, <harvestcraft:groundchickenitem>, <harvestcraft:groundchickenitem>);
...
#Presser:
mods.harvestcraft.Grinder.addAll(<ore:coal>, <harvestcraft:applejuiceitem>, <harvestcraft:applejuiceitem>);
...
#WaterFilter:
mods.harvestcraft.WaterFilter.addAll(<ore:ingotIron>, <harvestcraft:freshwateritem>, <harvestcraft:saltitem>);
...
#Market:
mods.harvestcraft.Market.addAll(<ore:coal>, <minecraft:log>, 3);
...
#ShippingBin:
mods.harvestcraft.ShippingBin.addAll(<ore:ingotGold>, <minecraft:apple>, 2);
